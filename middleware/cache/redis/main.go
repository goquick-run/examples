...
func (r *RedisAdapter) Set(ctx context.Context, key string,
	value string, expiration time.Duration) error {
...
func main() {
	...
	q.Get("/random", func(c *quick.Ctx) error {
		return c.String("Random number: " + time.Now().Format("15:04:05.000"))
	})
